...
function UploadArea({ fileInputRef, handleDragOver, handleDrop, handleFileSelect }) {
  return (
  ...
  return (
    <div className="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
      ...
      <button
        ...
        disabled={uploading}
        className="p-2 hover:bg-gray-200 rounded-full transition-colors disabled:opacity-50 flex-shrink-0"
      >
